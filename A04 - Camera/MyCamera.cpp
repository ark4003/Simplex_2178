...
vector3 changePosition(vector3 forward, bool front, bool back, bool left, bool right, vector3 currentPosition) {
...
void Simplex::MyCamera::CalculateViewMatrix(void)
{
	...
	//up should be a directional vector.  m_v3Above is a positional vector.  Need to subtract the position from the above to get the accurate directional vector.
