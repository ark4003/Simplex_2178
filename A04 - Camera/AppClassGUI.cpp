...
#pragma region Debugging Information
	...
	uint nEmptyLines = 19;
	//8 lines for including debug code.
	...
	/*
	m_pMeshMngr->PrintLine("current camera position:", C_BLUE);
	m_pMeshMngr->PrintLine(std::to_string(cameraPosition.x) + ", " + std::to_string(cameraPosition.y) + ", " + std::to_string(cameraPosition.z), C_RED);
	m_pMeshMngr->PrintLine("current camera target:", C_BLUE);
	m_pMeshMngr->PrintLine(std::to_string(cameraLook.x) + ", " + std::to_string(cameraLook.y) + ", " + std::to_string(cameraLook.z), C_RED);
	m_pMeshMngr->PrintLine("view change x", C_BLUE);
	m_pMeshMngr->PrintLine(std::to_string(viewChange.x), C_RED);
	m_pMeshMngr->PrintLine("view change y", C_BLUE);
	m_pMeshMngr->PrintLine(std::to_string(viewChange.y), C_RED);
	m_pMeshMngr->PrintLine("current look alteration:", C_BLUE);
	m_pMeshMngr->PrintLine(std::to_string(lookChange.x) + ", " + std::to_string(lookChange.y) + ", " + std::to_string(lookChange.z), C_RED);
	m_pMeshMngr->PrintLine("current position change:", C_BLUE);
	m_pMeshMngr->PrintLine(std::to_string(positionChange.x) + ", " + std::to_string(positionChange.y) + ", " + std::to_string(positionChange.z), C_RED);
	m_pMeshMngr->PrintLine("right Vector:", C_BLUE);
	m_pMeshMngr->PrintLine(std::to_string(rightVector.x) + ", " + std::to_string(rightVector.y) + ", " + std::to_string(rightVector.z), C_RED);
	*/
